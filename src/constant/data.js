export const menuItems = [
  ...
  },
  {
    ...
    child: [
      {
        childtitle: "New Loan",
        childlink: "default-form",
      },
      {
        childtitle: "Discontinue Loan",
        childlink: "discontinue-loan",
      },
    ],
  },

  {
    ...
    child: [
      {
        childtitle: "Deleted Branch",
        childlink: "soft-delete-branch",
      },
      // {
      //   childtitle: "Deleted Product",
      //   childlink: "soft-delete-product",
      // },
      {
        childtitle: "Deleted Agent",
        childlink: "soft-delete-agent",
      },
      // {
      //   childtitle: "Deleted Employee",
      //   childlink: "soft-delete-employee",
      // },
      {
        childtitle: "Deleted Client",
        childlink: "soft-delete-client",
      },
      // {
    ...
    child: [
      {
        ...
        childicon: "heroicons-outline:home",
      },
      {
        childtitle: "Branches",
        childlink: "branches",

        childicon: "heroicons:share",
      },
      {
        childtitle: "Agent",
        childlink: "agents",

        childicon: "heroicons:user-circle",
      },
      {
        childtitle: "Client",
