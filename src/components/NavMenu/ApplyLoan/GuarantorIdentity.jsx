...
const GuarantorIdentity = () => {
  ...
  const onSubmit = () => {
    navigate("/layout/applicant-identity-upload");
    setStepNumber((prev) => ({
      ...prev,
      prev: prev + 1,
    }));
    ...
    <div>
      <Card>
        ...
        <form onSubmit={onSubmit}>
          ...
          >
            <div className="adharCardFront mb-3">
              <label>
                <input
                  type="file"
                ...
                <p className="m-2">Adhar Card Front Image</p>
                {/* {<p className="text-red-600">{profileImageErr}</p>} */}
              </label>
            </div>
            <div className="adharCardBack mt-5 mb-3">
              <label>
                <input
                  type="file"
                  name="adharBackImage"
                ...
                <p className="m-2">Adhar Card Back Image</p>
            ...
            {/*----------------- PAN ------- */}
            <div className="panCardFront mb-3">
              <label>
                <input
                  type="file"
                  name="panFrontImage"
                ...
                <p className="m-2">Pan Card Front Image</p>

                {/* {<p className="text-red-600">{profileImageErr}</p>} */}
              </label>
            </div>
            <div className="panCardBack mb-3">
              <label>
                <input
                  type="file"
                  name="panBackImage"
                ...
                <p className="m-2">Pan Card Back Image</p>
            ...
            {/* ----------------Voter---------------------- */}
            <div className="voterCardFront mb-3">
              <label>
                <input
                  type="file"
                ...
                <p className="m-2">Voter Card Front Image</p>

                {/* {<p className="text-red-600">{profileImageErr}</p>} */}
              </label>
            </div>
            <div className="voterCardBack mb-3">
              <label>
                <input
                  type="file"
                  name="voterBackImage"
                ...
                <p className="m-2">Voter Card Back Image</p>
            ...
            <div className="dlFront mb-3">
              <label>
                ...
                <p className="m-2">Driving Licence Front Image</p>

                {/* {<p className="text-red-600">{profileImageErr}</p>} */}
              </label>
            </div>
            <div className="dlback mb-3">
              <label>
                <input
                  type="file"
                ...
                <p className="m-2">Driving Licence Back Image</p>
