...
import ForgotPass from "../ForgotPasswordForm";
import useDarkMode from "@/hooks/useDarkMode";

import LogoWhite from "@/assets/images/logo/logo-white.svg";
import Logo from "@/assets/images/logo/logo.svg";
import bgImage from "@/assets/images/all-img/login-bg.png";
import spkLogo from "@/assets/images/logo/spk-logo.jpg";
      ...
      <div className="lg-inner-column">
        <div className="left-columns lg:w-1/2 lg:block hidden">
          <div className="logo-box-3">
            {/* <Link to="/" className="">
              <img src={spkLogo} alt="" className="mb-10 w-14 rounded-full" />
            </Link> */}
          </div>
        </div>
